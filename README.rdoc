...
* Have controller A (BooksController) call a Class method in another class (FetchMetadata) which calls another controller (BookMetadataController) to get json
